...
| **청년 CRM101 4기**           | 2025.03.24 ~ **진행중..**     | 가상기업(야쉬자) **세일즈포스 도입** 프로젝트 <br><br> **-APEX**: 지오코딩 API 연동, 브랜드별 영업사원 자동할당<br> **-LWC**: 야쉬자맵(영업 방문일정 지도 시각화)<br> **-Flow**: 방문상담/견적서/현장실측 프로세스 자동화(Screen Flow)<br>     |
