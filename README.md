...
| **종합설계 프로젝트**           | 2024.09.01 ~ 2024.12.20 | **한국투자증권 API 연동 자동매매 서비스** 개발 <br><br> **-Python/Pandas**: 퀀트 알고리즘 분석/개발<br> **-Java/Spring**: 한국투자증권 API 연동/매매주문 API 개발/매매주문 계산 서비스 로직<br> **-Kotlin**: 안드로이드 앱 UI   |
